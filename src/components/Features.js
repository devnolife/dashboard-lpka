...
export default function Features() {
  ...
  return (
    // bagian ini nih yang ga mau center
            ...
            {features.map((feature, index) => (
              <div key={index} className="text-center">
                ...
                <div className={'flex justify-center'}>
                  <div
                    className={`flex justify-center items-center mb-6 w-16 h-16 rounded-full ${feature.bgColor}`}
                  >
                    {/* Gambar Ikon */}
      ...
      <section className="bg-white py-8 px-4">
        <div className="container mx-auto text-gray-800">
          ...
          <div className="relative">
            ...
            <div
              ref={scrollRef}
              className="flex overflow-hidden space-x-4 py-4 w-full"
            >
              <Pengumuman
...
const Pengumuman = ({
  ...
  return (
    <div
      className={`bg-white text-gray-800 rounded-lg shadow-xl overflow-hidden border border-gray-200 ${className}`}
    >
      {/* Card Image */}
      {image && (
